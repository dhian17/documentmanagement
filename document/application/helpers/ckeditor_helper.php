...
function form_ckeditor($data) {
    ...
    $options = '{' .
            ...
            filebrowserImageUploadUrl : "'.base_url().'upload/ckeditor_upload/image", // << My own file uploader
    ...
    return
            // fix: move to <HEAD...
            '<script type="text/javascript" src="' . base_url() . 'reources/ckeditor/ckeditor.js"></ script>' .
            // put the CKEditor
