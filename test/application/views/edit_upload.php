...
<div id="bg-isi"><h2>&nbsp;</h2><br />
<a href="<?php echo base_url(); ?>index.php/doc/tambahupload"><div class="pagingpage"><b> + Tambah File / Upload File</b></div></a>
<a href="<?php echo base_url(); ?>index.php/doc/katdownload"><div class="pagingpage"><b> + Kategori Download</b></div><br /><br /></a>
<table width="760" style="border: 1pt ridge #cccccc;" cellpadding="2" cellspacing="1" class="widget-small">
<?php echo form_open_multipart('doc/updateupload');?>
<?php
foreach($kategori->result_array() as $k)
{
$judul=$k["judul_file"];
$nomor_document=$k["nomor"];
$version_document=$k["version"];
$history_document=$k["history"];
$type_document=$k["type"];
...
<tr><td width="150">Nomor Document</td><td width="10">:</td><td><input type="text" name="nomor_document" class="textfield" size="50" value="<?php echo $nomor_document; ?>"></td></tr>

<tr><td width="150">Version</td><td width="10">:</td><td><input type="text" name="version_document" class="textfield" size="50" value="<?php echo $version_document; ?>"></td></tr>

<tr><td width="150">History</td><td width="10">:</td><td><input type="text" name="history_document" class="textfield" size="50" value="<?php echo $history_document; ?>"></td></tr>

<tr><td width="150">Type Document</td><td width="10">:</td><td><input type="text" name="type_docuemt" class="textfield" size="50" value="<?php echo $type_document; ?>">
