...
<tr>
    <td width="125">History</td>
    <td width="5">:</td>
	<td width="300"><textarea rows="3"value=' <?php echo form_input(array('name' => 'history', 'value' => set_value('history', isset($posts['history']) ? $posts['history'] : ''))); ?>'></textarea>&nbsp; <font color="#FF0000"><i><?php echo form_error('history');?></i></font></td></tr>
